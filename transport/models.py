...
class Transport_Anvers(models.Model):
    ...
    annual = models.DecimalField(max_digits=10, decimal_places=2, default=500)
...
class Taxes(models.Model):
    ...
    icosa = models.DecimalField(max_digits=10, decimal_places=2, default=12852)
    bss = models.DecimalField(max_digits=10, decimal_places=2, default=70)
